...
class NotificationGroupPage extends StatefulWidget {
  @override createState() => NotificationGroupState();
}
class NotificationGroupState extends State {
  var images = [];
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      persistentFooterButtons: <Widget>[
        ...
        (['teacher', 'administrator'].contains(roles[group]))?
  ...
  void delete() {
    ...
    var group = notificationSelection['group'];
    dbRef.child('formation/$group/notifications/$key').remove();
